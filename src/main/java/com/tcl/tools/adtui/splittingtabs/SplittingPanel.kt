...
import com.tcl.tools.adtui.splittingtabs.SplittingTabsBundle.lazyMessage
import com.tcl.tools.adtui.splittingtabs.state.PanelState
import com.tcl.tools.adtui.splittingtabs.state.SplittingTabsStateProvider
...
internal class SplittingPanel(
  ...
  private val popupActionGroup = SimpleActionGroup().apply {
    name = "Foobar"
    add(SplitPanelAction(SplitOrientation.VERTICAL))
    add(SplitPanelAction(SplitOrientation.HORIZONTAL))
