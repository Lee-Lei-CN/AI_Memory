 ...
 */
package com.tcl.tools.adtui.splittingtabs.state
...
import com.tcl.tools.adtui.splittingtabs.SplittingPanel

@State(name = "com.tcl.tools.adtui.splittingtabs.state.SplittingTabsState", storages = [Storage(StoragePathMacros.PRODUCT_WORKSPACE_FILE)])
