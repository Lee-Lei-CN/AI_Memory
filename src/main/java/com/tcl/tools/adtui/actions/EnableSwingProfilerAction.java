 ...
 */
package com.tcl.tools.adtui.actions;
...
public class EnableSwingProfilerAction extends DumbAwareToggleAction {
  private static final Key<Object> SERVICE_KEY = Key.create("com.tcl.tools.swingp.server.StatsSerializer");
  ...
  public void setSelected(@NotNull AnActionEvent event, boolean state) {
    ...
    if (serializer == null && state) {
      ...
      try {
        Class<?> serializerClass = Class.forName("com.tcl.tools.swingp.server.StatsSerializer");
