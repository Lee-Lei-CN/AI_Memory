...
import com.tcl.tools.adtui.stdui.CommonComboBoxRenderer;
import com.tcl.tools.adtui.stdui.StandardColors;
import com.tcl.tools.adtui.stdui.StandardDimensions;
...
public class CommonMenuUI extends BasicMenuUI {
  ...
  public void installUI(@NotNull JComponent component) {
    ...
    if (border == null || border instanceof CommonComboBoxRenderer.UIResource) {
      component
