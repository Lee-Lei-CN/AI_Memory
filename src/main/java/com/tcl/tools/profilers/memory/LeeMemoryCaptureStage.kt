...
class LeeMemoryCaptureStage(
    profilers: StudioProfilers?,
    loader: CaptureObjectLoader,
    val startTime: Long,
    val duration: Long,
    val captureObject: CaptureObject
) : LeeBaseMemoryProfilerStage(profilers, loader) {
    ...
    override fun getStageType() = captureObject::class.java.let {
        when {
