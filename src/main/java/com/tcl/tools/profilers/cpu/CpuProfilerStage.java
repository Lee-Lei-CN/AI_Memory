...
import static com.tcl.tools.profilers.StudioProfilers.DAEMON_DEVICE_DIR_PATH;
...
import com.tcl.tools.adtui.model.RangeSelectionListener;
...
import com.tcl.tools.adtui.model.legend.SeriesLegend;
import com.tcl.tools.adtui.model.updater.Updatable;
import com.tcl.tools.adtui.model.updater.UpdatableManager;
...
import com.tcl.tools.profilers.cpu.*;import com.tcl.tools.profilers.cpu.capturedetails.CaptureDetails;
import com.tcl.tools.profilers.cpu.capturedetails.CaptureModel;
import com.tcl.tools.profilers.cpu.config.ArtInstrumentedConfiguration;
...
import com.tcl.tools.profilers.cpu.systemtrace.CpuKernelModel;
...
public class CpuProfilerStage extends StreamingStage implements CodeNavigator.Listener {
  ...
  private void onCaptureSelection() {
    ...
    if ((getCaptureState() == CaptureState.IDLE)
        || (getCaptureState() == CaptureState.CAPTURING)) {
