...
import com.tcl.tools.profilers.cpu.CaptureNode;import com.tcl.tools.profilers.cpu.nodemodel.CaptureNodeModel;
...
public class VisualNodeCaptureNode extends CaptureNode {
   ...
   * only used for visualizing data. An example of where this is used is benficial is the {@link com.tcl.tools.profilers.cpu.analysis.CpuAnalysisChartModel}
   */
  @Override
