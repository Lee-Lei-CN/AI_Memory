...
public final class FakeFeatureTracker implements FeatureTracker {
  ...
  /**
   * Stores the last boolean value of {@link } passed to track API tracing.
   */
  ...
  @Override
  public void trackCreateSession(Common.SessionMetaData.SessionType sessionType, com.tcl.tools.profilers.sessions.SessionsManager.SessionCreationSource sourceType) {
  ...
  @Override
  public void trackSessionArtifactSelected(@NotNull com.tcl.tools.profilers.sessions.SessionArtifact artifact, boolean isSessionLive) {
  ...
  @Override
  public void trackCpuStartupProfiling(@NotNull Common.Device device, @NotNull com.tcl.tools.profilers.cpu.config.ProfilingConfiguration configuration) {
  ...
  @Override
  public void trackMemoryProfilerInstanceFilter(@NotNull com.tcl.tools.profilers.memory.adapters.instancefilters.CaptureObjectInstanceFilter filter) {
