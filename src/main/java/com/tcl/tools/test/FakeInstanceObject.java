...
public final class FakeInstanceObject implements InstanceObject {
  ...
  @Nullable private final Memory.AllocationStack myAllocationStack;
  ...
  private FakeInstanceObject(@NotNull String name,
                             ...
                             @Nullable Memory.AllocationStack allocationStack,
  ...
  public static class Builder {
    ...
    @Nullable private Memory.AllocationStack myAllocationStack = null;
    ...
    @NotNull
    public Builder setAllocationStack(@Nullable Memory.AllocationStack allocationStack) {
      myAllocationStack = allocationStack;
      return this;
    }
