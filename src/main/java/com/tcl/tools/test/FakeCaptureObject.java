...
public final class FakeCaptureObject implements CaptureObject {
  ...
  public static class Builder {
    ...
    @NotNull private List<ClassifierAttribute> myClassifierAttributes = Arrays.asList(ClassifierAttribute.values());
    @NotNull private List<InstanceAttribute> myInstanceAttributes = Arrays.asList(InstanceAttribute.values());
