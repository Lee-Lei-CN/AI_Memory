...
import static com.tcl.tools.idea.profilers.AndroidProfilerToolWindow.LAST_RUN_APP_INFO;
...
import com.tcl.tools.idea.profilers.AndroidProfilerToolWindowFactory;import com.tcl.tools.idea.profilers.PreferredProcessInfo;import com.tcl.tools.idea.profilers.ProfileRunExecutor;import com.tcl.tools.idea.profilers.analytics.StudioFeatureTracker;
...
import com.tcl.tools.idea.util.StudioPathManager;
  ...
  public static final class AndroidProfilerToolWindowLaunchTask implements LaunchTask {
    ...
    private long getCurrentDeviceTime(@NotNull IDevice device) {
      ...
      try {
        ...
        if (!Transport.TimeResponse.getDefaultInstance().equals(timeResponse)) {
