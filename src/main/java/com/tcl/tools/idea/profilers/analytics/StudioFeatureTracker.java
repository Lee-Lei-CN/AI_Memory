 ...
 */
package com.tcl.tools.idea.profilers.analytics;
...
import com.tcl.tools.profilers.memory.HprofSessionArtifact;
import com.tcl.tools.profilers.memory.LegacyAllocationsSessionArtifact;
...
import com.tcl.tools.profilers.sessions.SessionArtifact;
...
public final class StudioFeatureTracker implements FeatureTracker {
  ...
  public void trackCreateSession(Common.SessionMetaData.SessionType sessionType, SessionsManager.SessionCreationSource sourceType) {
    ProfilerSessionCreationMetaData.Builder builder = ProfilerSessionCreationMetaData.newBuilder()
      ...
      .setCreationSource(SESSION_CREATION_SOURCE_MAP.getOrDefault(sourceType, ProfilerSessionCreationMetaData.CreationSource.UNKNOWN_SOURCE));
  ...
  @Override
  public void trackCaptureTrace(@NotNull com.tcl.tools.profilers.cpu.CpuCaptureMetadata cpuCaptureMetadata) {
  ...
  @Override
  public void trackSelectEnergyRange(@NotNull com.tcl.tools.profilers.analytics.energy.EnergyRangeMetadata rangeMetadata) {
    newTracker(AndroidProfilerEvent.Type.SELECT_ENERGY_RANGE).setEnergyRangeMetadata(rangeMetadata).track();
  }

  @Override
  public void trackSelectEnergyEvent(@NotNull com.tcl.tools.profilers.analytics.energy.EnergyEventMetadata eventMetadata) {
    newTracker(AndroidProfilerEvent.Type.SELECT_ENERGY_EVENT).setEnergyEventMetadata(eventMetadata).track();
  }

  @Override
  public void trackFilterMetadata(@NotNull com.tcl.tools.profilers.analytics.FilterMetadata filterMetadata) {
  ...
  private static final class Tracker {
    ...
    @Nullable private com.tcl.tools.profilers.cpu.CpuCaptureMetadata myCpuCaptureMetadata;
    @Nullable private CpuImportTraceMetadata myCpuImportTraceMetadata;
    @Nullable private com.tcl.tools.profilers.analytics.FilterMetadata myFeatureMetadata;
    @Nullable private CpuApiTracingMetadata myCpuApiTracingMetadata;
    @Nullable private com.tcl.tools.profilers.analytics.energy.EnergyRangeMetadata myEnergyRangeMetadata;
    @Nullable private com.tcl.tools.profilers.analytics.energy.EnergyEventMetadata myEnergyEventMetadata;
    ...
    @NotNull
    public Tracker setCpuCaptureMetadata(@Nullable com.tcl.tools.profilers.cpu.CpuCaptureMetadata cpuCaptureMetadata) {
    ...
    @NotNull
    public Tracker setFilterMetadata(@Nullable com.tcl.tools.profilers.analytics.FilterMetadata filterMetadata) {
      myFeatureMetadata = filterMetadata;
      return this;
    }

    @NotNull
    public Tracker setEnergyRangeMetadata(@Nullable com.tcl.tools.profilers.analytics.energy.EnergyRangeMetadata energyRangeMetadata) {
      myEnergyRangeMetadata = energyRangeMetadata;
      return this;
    }

    @NotNull
    public Tracker setEnergyEventMetadata(@Nullable com.tcl.tools.profilers.analytics.energy.EnergyEventMetadata energyEventMetadata) {
